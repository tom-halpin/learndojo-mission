...
class TopicTypeAddForm extends FormBase {
    ...
    function submitForm(array &$form, FormStateInterface $form_state) {
        ...
        if (!empty($this -> id)) {
            try {
                TopicTypeStorage::edit($this -> id, SafeMarkup::checkPlain($name), SafeMarkup::checkPlain($description));
            ...
            try {
                TopicTypeStorage::add(SafeMarkup::checkPlain($name), SafeMarkup::checkPlain($description));
