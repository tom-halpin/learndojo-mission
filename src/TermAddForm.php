...
class TermAddForm extends FormBase {
    ...
    function submitForm(array &$form, FormStateInterface $form_state) {
        ...
        if (!empty($this -> id)) {
            try {
                TermStorage::edit($this -> id, SafeMarkup::checkPlain($name), SafeMarkup::checkPlain($description));
            ...
            try {
                TermStorage::add(SafeMarkup::checkPlain($name), SafeMarkup::checkPlain($description));
