...
class MissionDeleteForm extends ConfirmFormBase {
  protected $id;
  protected $name;
  ...
  function getQuestion() {
    return t('Are you sure you want to delete mission ' . $this->name . '?'); 
  }
  ...
  function submitForm(array &$form, FormStateInterface $form_state) {
    try
    {
        MissionStorage::delete($this->id);
        drupal_set_message(t('Mission: ' . $this->name . ' has been deleted.'  ));
    }
    catch(\Exception $e) {
        drupal_set_message(t("Sorry, that did not work. Please ensure Mission: " . $this->name . " is not being used in the definition of a Strand."), 'error');
        //return;
    }
